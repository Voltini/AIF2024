...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_path",
        type=str,
        default="../data/landscapes",
        help="dataset path",
    )
    parser.add_argument(
        "--batch_size", type=int, default=int(32), help="batch_size"
    )
    parser.add_argument(
        "--lr", type=float, default=float(1e-3), help="learning rate"
    )
    parser.add_argument(
        "--epochs", type=int, default=int(10), help="number of epochs"
    )
    ...
    loader = get_colorized_dataset_loader(
        path=data_path, batch_size=batch_size, shuffle=True, num_workers=4
    )
